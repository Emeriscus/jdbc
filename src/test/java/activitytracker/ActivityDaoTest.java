...
//        dataDao = new DatabaseMetadataDao(dataSource);
        ...
        Activity activity1 = new Activity(LocalDateTime.of(2021, 2, 22, 15, 35), "futás a parkban", Type.RUNNING);
        dao.saveActivity(activity1);
        Activity activity2 = new Activity(LocalDateTime.of(2020, 8, 10, 11, 12), "Egész héten Zemplén!!!", Type.HIKING);
        dao.saveActivity(activity2);
        Activity activity3 = new Activity(LocalDateTime.of(2020, 10, 2, 8, 15), "egész napos bicótúra", Type.BIKING);
        dao.saveActivity(activity3);
        Activity activity4 = new Activity(LocalDateTime.of(2021, 1, 22, 9, 46), "meccs az iskola tornatermében", Type.BASKETBALL);
        dao.saveActivity(activity4);
        Activity activity5 = new Activity(LocalDateTime.of(2020, 12, 22, 7, 52), "kis kör a tó körül", Type.RUNNING);
    ...
    void testFindActivityById() {
        ...
        Assertions.assertEquals(Type.BASKETBALL, activity.getType());
    }
    ...
    void testListActivities() {
        ...
        Assertions.assertEquals(Type.RUNNING, activities.get(4).getType());
    }

    @Test
    void testSaveActivityAndReturnGeneratedKeys() {
        Activity activity = new Activity(LocalDateTime.of(2021, 2, 23, 9, 56), "séta a kertben a napon", Type.RUNNING);
    ...
    void testSaveActivitywithTrackPointsSomethingIsWrong() {
        ...
        Exception ex1 = Assertions.assertThrows(IllegalArgumentException.class, () -> dao.saveActivityAndTrackPoints(activity));
